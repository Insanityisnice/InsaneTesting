...
namespace System.Data
{
    ...
    {
        public static List<TResult> ToList<TResult>(this IDataReader reader, Func<IDataReader, TResult> function)
        {
            if (function == null)
            {
        ...
        public static Dictionary<TKey, TValue> ToDictionary<TKey, TValue>(this IDataReader reader, Func<IDataReader, TValue> function, Func<TValue, TKey> keySelector, IEqualityComparer<TKey> equalityComparer = null)
        {
            if (function == null)
            {
                throw new ArgumentNullException("function");
